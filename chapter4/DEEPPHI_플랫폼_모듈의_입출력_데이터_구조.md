...
|                Dictionary Key:value               |                    Data Explanation                   |                        Data Example                        |
|:-------------------------------------------------:|:-----------------------------------------------------:|:----------------------------------------------------------:|
| data['label']['detection']['bbox_coordinate']     | [xmin,ymin,xmax,ymax] box의 좌표 값                   | np.array([[173., 150., 348., 350.], [10., 10., 50., 80.]]) |
...
| data['prediction']['detection']['bbox_coordinate'] | prediction result의 bbox 좌표 정보가 담긴 결과          | np.array([180., 149. 350. 348]) |
| data['prediction']['detection']['bbox_class']      | prediction result의 해당 bbox의 클래스 정보가 담긴 결과 | np.array([1.,0.,0.,0.,0.])      |
| data['prediction']['detection']['header']          | 메타데이터 보관을 위한 비어 있는 Dictionary             |                                 |