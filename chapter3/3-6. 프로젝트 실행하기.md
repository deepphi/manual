...
예시로, [256*256] <span style="color:green">Resize</span> 모듈을 통과한 후 모든 데이터의 크기가 <span style="color:red">[256*256]</span>으로 통일되었음을 확인할 수 있고,
...
![View Tab](img/3-6/manual_3-6_2_4.png)
